...
<li
    class="group relative flex flex-col items-start justify-between bg-neutral-900 border border-neutral-800 rounded-xl p-6 transition-all hover:ring-1 hover:ring-neutral-700">
    ...
    <p class="relative z-10 mt-6 flex text-sm font-medium transition group-hover:text-teal-500 text-zinc-200">
        ...
        <span class="ml-2 truncate max-w-80">
